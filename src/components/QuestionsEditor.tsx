    ...
    <div className="space-y-3 rounded-xl border border-neutral-200 bg-white p-4">
      ...
      {drafts.map((d, i) => (
        <div key={d.id} className="space-y-1 border-t border-neutral-100 pt-3 first:border-0 first:pt-0">
          <label className="block text-xs font-medium text-neutral-500">Question {i + 1} title</label>
          <input
            type="text"
            value={d.label_short}
          ...
          />
          <label className="block text-xs font-medium text-neutral-500">Helper text</label>
          <textarea
