...
export function GroupSettingsForm({ group }: GroupSettingsFormProps) {
  ...
  return (
    <div className="space-y-3 rounded-xl border border-neutral-200 bg-white p-4">
      <h2 className="text-xl font-semibold text-brand-navy">Meeting day</h2>
      ...
      <div>
        ...
        <div className="flex gap-2">
          <select
            ...
            className="flex-1 rounded-md border border-neutral-300 px-3 py-2 text-[17px]"
          >
        ...
        {timezoneError && <p className="mt-1 text-[17px] text-red-600">{timezoneError}</p>}
      </div>
      ...
      <p className="rounded-md bg-neutral-100 px-3 py-2 text-[17px] text-neutral-600">
      ...
      {dayError && <p className="text-[17px] text-red-600">{dayError}</p>}
      {lockDateMessage && <p className="text-[17px] text-neutral-700">{lockDateMessage}</p>}
    </div>
  );
}
