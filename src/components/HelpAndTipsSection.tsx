...
import { CheckInIcon, GroupIcon, SettingsIcon, FlagIcon, QuestionCircleIcon } from "@/components/NavIcons";

// Round 19 visual redesign: a small leading icon per topic (iOS Settings
// pattern), subsections grouped into rounded-rectangle cards with divider
// lines instead of plain scrolling text, and every subsection as an
// inline-expand row instead of a further slide-over — all three applied
// uniformly across all six topics, not just the two that used to be
// longer, so the section reads as one consistent design.
...
// Every subsection (and every FAQ question) uses this same inline-expand
// row — matching the pattern already used and liked elsewhere in the app
// (Prayer & Life Update, Goals, Group Update) — rather than a further
// slide-over on top of the topic page someone is already two levels deep
// into.
...
const TOPICS: { id: string; title: string; icon: ReactNode; body: ReactNode }[] = [
  {
    id: "home-screen",
  ...
  },
  {
    ...
    icon: (
      <IconBadge>
        <CheckInIcon filled={false} className="h-5 w-5" />
      </IconBadge>
    ),
    body: (
      <>
        ...
        <Card>
          <Row title="Your Weekly Check-in">
            ...
            <p>
              Choose the answer that is most accurate, not the answer you think you should give.
              The purpose is to give your group an honest picture of how you are doing so you can
              encourage and help one another.
            </p>
            <p>You can change any of your answers until the week&apos;s deadline.</p>
          </Row>
          <Row title="Category Descriptions">
          ...
          <Row title="Meeting Date">
            <p>Near the top of the Check-in screen you will see your group&apos;s upcoming meeting date.</p>
            <p>Your check-in remains open through 11:59 PM on that meeting day. After the deadline, that week&apos;s answers are locked and a new week begins.</p>
            <p>If you miss a week, nothing carries forward from the previous week. The new week simply begins blank.</p>
          </Row>
        </Card>
        <Card>
          <Row title="Prayer & Life Update">
  ...
  },
  {
    ...
    icon: (
      <IconBadge>
        <GroupIcon filled={false} className="h-5 w-5" />
      </IconBadge>
    ),
    body: (
      <>
        <p>The Dashboard gives your group a quick picture of how everyone is doing this week.</p>
        <Card>
          <Row title="Reading the Dashboard">
        ...
        <Card>
          <Row title="Opening a Member's Information">
          ...
          <Row title="Viewing Someone's History">
          ...
          <Row title="Viewing Your Own History">
        ...
        <Card>
          <Row title="Group Update">
            ...
            <p className="italic text-neutral-500">
              Leaders: see the Leader Guide section for how to edit your Group Update.
            </p>
          </Row>
        </Card>
      </>
  ...
  },
  {
    ...
    icon: (
      <IconBadge>
        <SettingsIcon filled={false} className="h-5 w-5" />
      </IconBadge>
    ),
    body: (
      <>
        ...
        <Card>
          <Row title="Profile">
            ...
            <p>
              You can update your email address anytime from your Profile. Since your email is
              also what you use to log in, a confirmation link is sent to the new address, and the
              change takes effect once you confirm it, this keeps your account secure and makes
              sure a typo can&apos;t accidentally lock you out. Your password stays exactly the
              same; only the email itself changes.
            </p>
          </Row>
        </Card>
        <Card>
          <Row title="Your Groups">
        ...
        <Card>
          <Row title="Finding the App's Link">
            <p>
              Your Settings page includes a copy of the app&apos;s web address, with a Copy button
              right beside it so you can copy it in one tap instead of trying to select and copy
              the text yourself. Use this if you ever need to open the app on a new device, or if
              you want to share the exact link alongside a group code when inviting someone to
              join.
            </p>
          </Row>
        </Card>
  ...
  },
  {
    ...
    body: (
      <>
        <p>If you create a group, you become the leader for that group and receive additional tools for managing it.</p>
        <Card>
          <Row title="Creating Your Group">
        ...
        <Card>
          ...
          <Row title="Managing Weekly Questions">
        ...
        <Card>
          <Row title="Removing a Member">
            ...
            <p>
              ...
              removed from, but any request will need to be approved again before he regains
              access.
            </p>
          </Row>
        </Card>
        ...
        <Card>
          <Row title="Deactivating a Group">
  ...
  },
  {
    ...
    body: (
      <Card>
        <Row title="What happens if I miss a week?">
          <p>Nothing carries over. The new week simply starts blank, and you can check in normally next time.</p>
        </Row>
        <Row title="Can I change my answers after I submit them?">
          <p>Yes, anytime before your group&apos;s weekly deadline (11:59 PM on your meeting day). After that, your answers lock.</p>
        </Row>
        <Row title="Who can see my Prayer & Life Update?">
          <p>Everyone in your group, not just the leader.</p>
        </Row>
        <Row title="Can other members see who reacted to my update?">
          <p>No. Reactions are anonymous counters, your group can see that someone responded, not who.</p>
        </Row>
        <Row title="What's the difference between my weekly ratings and my goals?">
          <p>Ratings reset every week. Goals don&apos;t, they stay exactly as you set them until you change them yourself.</p>
        </Row>
        <Row title="Can I be part of more than one group?">
          <p>Yes. In Settings, you can start a new group or join another one yourself anytime, and switch your active group whenever you want. Each group you&apos;re part of is independent.</p>
        </Row>
        <Row title="I was removed from a group, can I rejoin?">
          <p>Yes, but you&apos;ll need to be approved again, just like any new member.</p>
        </Row>
        <Row title="If I'm in two groups, do I need to answer the questions twice?">
          <p>Yes. Your ratings, prayer requests, and goals don&apos;t carry over between groups, each group is completely separate, so you&apos;ll check in for each one on its own.</p>
        </Row>
        <Row title="What happens to my history if my leader deactivates the group?">
          <p>Your own personal history stays fully accessible to you. You&apos;ll also be able to see a simple list of who was in the group, though not anyone else&apos;s private answers.</p>
        </Row>
      </Card>
    ),
  },
      ...
      <div className="space-y-2 rounded-xl border border-neutral-200 bg-white p-4">
        ...
        <div className="divide-y divide-neutral-100">
          {TOPICS.map((topic) => (
            ...
            >
              {topic.icon}
              <span className="flex-1 text-[17px] font-medium text-neutral-700">{topic.title}</span>
