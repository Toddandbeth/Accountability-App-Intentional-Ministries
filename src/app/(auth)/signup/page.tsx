...
// Fixed full-bleed overlays rather than relying on the shared
// (auth)/layout.tsx background — that layout stays light for
// forgot-password/reset-password, but the login -> sign-up -> check your
// email -> welcome sequence should read as one consistent navy flow.
export default function SignupPage() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col items-center justify-center overflow-y-auto bg-brand-navy px-4 py-8">
      <Image
        src="/brand/IM_-_Main_-_white.png"
        alt="Intentional Ministries"
        width={1076}
